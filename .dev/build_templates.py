...
def pat(slug, indent="\t\t\t"):
    return indent + '<!-- wp:pattern {"slug":"dreamrs/%s"} /-->' % slug


def main_padded(inner):
    # 70 top and bottom: the template's 130px blog area at desktop, fluid down.
    return (
        '<!-- wp:group {"tagName":"main","className":"dreamrs-main","style":{"spacing":{"padding":'
        '{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->\n'
        '<main class="wp-block-group dreamrs-main" style="padding-top:var(--wp--preset--spacing--70);'
...
def main_flush(inner):
    return (
        '<!-- wp:group {"tagName":"main","className":"dreamrs-main","layout":{"type":"constrained"}} -->\n'
        '<main class="wp-block-group dreamrs-main">\n%s\n</main>\n<!-- /wp:group -->' % inner
    )
...
def with_sidebar(content):
    ...
    return (
        '\t<!-- wp:columns {"className":"dreamrs-with-sidebar","style":{"spacing":{"blockGap":'
        '{"top":"var:preset|spacing|60","left":"var:preset|spacing|40"}}}} -->\n'
        '\t<div class="wp-block-columns dreamrs-with-sidebar">\n'
...
PAGE_CONTENT = ('\t<!-- wp:post-content {"align":"full","className":"dreamrs-page-content",'
...
def single_body(indent):
    lines = [
        ...
        '<!-- wp:pattern {"slug":"dreamrs/hidden-post-meta"} /-->',
        '<!-- wp:post-content {"className":"dreamrs-entry","layout":{"type":"constrained"}} /-->',
        '<!-- wp:post-terms {"term":"post_tag","className":"dreamrs-tags","fontSize":"small"} /-->',
        '<!-- wp:group {"className":"dreamrs-post-nav","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->',
        '<div class="wp-block-group dreamrs-post-nav">',
        ...
        '</div>',
        '<!-- /wp:group -->',
        '<!-- wp:pattern {"slug":"dreamrs/hidden-author"} /-->',
        '<!-- wp:pattern {"slug":"dreamrs/hidden-comments"} /-->',
    ]
...
def templates():
    ...
    out = {
        ...
        "404": HEADER + main_flush(pat("hidden-404", "\t")) + FOOTER,
...
def main():
    ...
    for part in ("header", "footer", "sidebar"):
        with open("parts/%s.html" % part, "w") as fh:
            fh.write('<!-- wp:pattern {"slug":"dreamrs/%s"} /-->\n' % part)
