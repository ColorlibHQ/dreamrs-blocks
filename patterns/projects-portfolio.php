<?php
/**
 * Title: Projects: portfolio of six
 * Slug: dreamrs/projects-portfolio
 * Categories: dreamrs-sections
 * Keywords: projects, portfolio, gallery, filter
...
?>
<!-- wp:group {"align":"full","className":"dreamrs-section dreamrs-projects","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained"},"anchor":"portfolio"} -->
<div class="wp-block-group alignfull dreamrs-section dreamrs-projects" id="portfolio" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:heading {"className":"is-style-dreamrs-rule-after","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}},"fontSize":"title"} -->
...
<h2 class="wp-block-heading">Houses, towers and the rooms <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-color">inside.</mark></h2>
<!-- /wp:heading -->
...
<!-- wp:columns {"className":"dreamrs-split dreamrs-projects__grid","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|60","left":"var:preset|spacing|60"}}}} -->
<div class="wp-block-columns dreamrs-split dreamrs-projects__grid"><!-- wp:column {"width":"41.66%"} -->
<div class="wp-block-column" style="flex-basis:41.66%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|70"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"dreamrs-project dreamrs-project\u002d\u002darchitecture","layout":{"type":"constrained"}} -->
<div class="wp-block-group dreamrs-project dreamrs-project--architecture"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"15/16","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/apartment-glasshouse.webp' ) ); ?>" alt="A glass-clad office block with a stepped façade against a blue sky" style="aspect-ratio:15/16;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:heading {"level":3,"fontSize":"title"} -->
<h3 class="wp-block-heading has-title-font-size"><a href="<?php echo esc_url( home_url( '/projects/' ) ); ?>">The Glasshouse</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"dreamrs-project dreamrs-project\u002d\u002darchitecture","layout":{"type":"constrained"}} -->
<div class="wp-block-group dreamrs-project dreamrs-project--architecture"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"15/16","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/apartment-steel.webp' ) ); ?>" alt="An orange steel A-frame tower with a zigzag staircase climbing inside it, against a pale sky" style="aspect-ratio:15/16;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:heading {"level":3,"fontSize":"title"} -->
<h3 class="wp-block-heading has-title-font-size"><a href="<?php echo esc_url( home_url( '/projects/' ) ); ?>">Stair Tower</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-group"><!-- wp:group {"className":"dreamrs-project dreamrs-project\u002d\u002dexterior","layout":{"type":"constrained"}} -->
<div class="wp-block-group dreamrs-project dreamrs-project--exterior"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"15/16","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/apartment-avenue.webp' ) ); ?>" alt="A tree-lined avenue running between brick high-rises towards a distant art deco spire" style="aspect-ratio:15/16;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:heading {"level":3,"fontSize":"title"} -->
<h3 class="wp-block-heading has-title-font-size"><a href="<?php echo esc_url( home_url( '/projects/' ) ); ?>">Avenue Apartments</a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
