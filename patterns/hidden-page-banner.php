...
/**
 * Title: Page banner
 * Slug: dreamrs/hidden-page-banner
...
<div class="wp-block-group"><!-- wp:post-title {"level":1,"style":{"typography":{"textAlign":"center"}},"textColor":"overlay","fontSize":"colossal"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
